...
namespace Hazel
{
	...
	void ImGuiLayer::OnAttach()
	{
		...
		//Temporery: should eventually use Hazel Key Codes
		...
		ImGui_ImplOpenGL3_Init("#version 460"); // Initialize OpenGL3 Renderer with GLSL version 460
	...
	void ImGuiLayer::OnUpdate()
	{
		...
		io.DisplaySize = ImVec2(app.GetWindow().GetWidth(), app.GetWindow().GetHeight());//io.DisplaySize = ImVec2(app.Get().GetWindow().GetWidth(), app.Get().GetWindow().GetHeight());
		...
		/*
io.DeltaTime = (float)glfwGetTime() - m_Time; // Set Delta Time
		//HZ_PROFILE_FUNCTION();
			ImGuiIO& io = ImGui::GetIO();
